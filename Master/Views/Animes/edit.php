    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <form action="../../Controllers/AnimeController.php" method="post">
                    <input type="hidden" name="id" value="<?= $_GET["id"]; ?>">
                    <div class="row mb-3">
                        <label for="title" class="col-sm-2 col-form-label">Title</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="title" name="title" autofocus value="<?= $anime->title; ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="synopsis" class="col-sm-2 col-form-label">Synopsis</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" aria-label="With textarea" id="synopsis" name="synopsis"><?= $anime->synopsis; ?></textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="studio" class="col-sm-2 col-form-label">Studio</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="studio" name="studio" value="<?= $anime->studio; ?>">
                        </div>
                    </div>
                    <div class=" row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="rating" name="rating" value="<?= $anime->rating; ?>" min="0" max="10">
                        </div>
                    </div>
                    <button type=" submit" class="btn btn-outline-primary">Change Data</button>
                    <a class="btn btn-outline-danger" href="detail.php?id=<?= $_GET["id"]; ?>">Cancel</a>
                </form>
            </div>
        </div>
    </div>
